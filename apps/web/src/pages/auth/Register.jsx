          ...
          <div className="w-full max-w-md space-y-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                onClick={() => navigate("/")}
                className="flex items-center justify-center space-x-2 py-2 px-3 border border-slate-200 rounded-xl bg-white hover:bg-slate-50 transition-all shadow-sm active:scale-[0.98] cursor-pointer"
              >
